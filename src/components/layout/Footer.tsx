...
const Footer = () => {
  ...
  const footerLinks = {
    platform: [
      ...
      { label: t.footer.findWork, href: '/jobs' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4 no-underline">
              ...
              <span className="text-xl font-bold text-heading">РаботаПро</span>
            </Link>
            ...
            <ul className="space-y-3">
              {footerLinks.platform.map((link) => (
                <li key={link.href}>
                  <Link
                    to={link.href}
                    className="text-small text-muted-foreground hover:text-link transition-colors no-underline hover:underline"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-small text-muted-foreground">
            © {new Date().getFullYear()} РаботаПро. {t.footer.rights}
          </p>
