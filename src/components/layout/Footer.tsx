...
const Footer = () => {
  ...
  const footerLinks = {
    platform: [
      { label: t.footer.findTalent, href: '/talent' },
      { label: t.footer.findWork, href: '/work' },
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-1 group">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-foreground group-hover:gradient-text transition-all duration-300">Gladiator Jobs</span>
            </Link>
          ...
          {/* Platform Links */}
          <div>
            <h4 className="text-sm font-bold text-foreground mb-4 gradient-text">
              {t.footer.platform}
            </h4>
        ...
        <div className="mt-12 pt-8 border-t border-primary/20 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground font-medium">
            © {new Date().getFullYear()} <span className="gradient-text font-bold">Gladiator Jobs</span>. {t.footer.rights}
          </p>
          <div className="flex items-center gap-4">
            <a
              ...
              className="p-2 rounded-lg glass border border-border/50 text-muted-foreground hover:text-primary hover:border-primary/50 hover:scale-110 transition-all duration-300"
            >
